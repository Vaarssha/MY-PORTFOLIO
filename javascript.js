...
const projects = [
    { name: 'E-Commerce', description: 'This is my front-end project based on html and css where the user can avail offers online.' , way: 'Click here to check the website'},
